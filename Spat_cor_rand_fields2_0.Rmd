...
#put the names of the simulations (sim1, sim2...) in a vector
sim_names = names(k_fields)
#calculate the mean and standard deviation of these simulation (i.e. the ln(k) distribution)
